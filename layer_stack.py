...
class LayerStackParameters:
    ...
    thickness_wg: float = 0.35 # um
    sidewall_angle_wg: float = 0 # degrees
    thickness_clad: float = 3.0
    substrate_thickness: float = 10.0
    box_thickness: float = 4.5
    # undercut_thickness: float = 5.0


def get_layer_stack(
    # simple LayerStack for passive waveguide devices   
    ...
    # layer assignment arguments
    layer_wafer: LogicalLayer = LogicalLayer(layer=LAYERS.WAFER), # hardcoded WAFER layer
    layer_core: LogicalLayer = LogicalLayer(layer=LAYERS.WG),
    ...
    # material assignment arguments
    material_wafer: str = "si",
    material_box: str = "sio2",
    material_core: str = "si3n4",
    material_clad: str = "air"
    ...
    layers = dict(
        ...
        core=LayerLevel(
            ...
            width_to_z=0.5,
            derived_layer=LogicalLayer(layer=LAYERS.WG),
        ),
